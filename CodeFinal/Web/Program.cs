...
builder.Services.AddScoped<IWeddingMainRepository, WeddingMainRepository>();   
...
builder.Services.AddScoped<AdminServiceAbstract.IShopProductService, AdminServiceConcrete.ShopProductService>();
builder.Services.AddScoped<AdminServiceAbstract.IShopProductService, AdminServiceConcrete.ShopProductService>();
builder.Services.AddScoped<AdminServiceAbstract.IProductCategoryService, AdminServiceConcrete.ProductCategoryService>();    
